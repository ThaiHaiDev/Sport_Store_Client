            ...
            <div className="modalCategory-container">
                ...
                <div className="modalCategory-body">
                    <form onSubmit={submitFormHandler}>
                        <label className="modalCategory-label">First name</label>
                        <input
                        ...
                        <label className="modalCategory-label">Last name</label>
                        <input
                            className="modalCategory-input"
                            type="text"
                            id="last"
                        ...
                        <label className="modalCategory-label">Email</label>
                        <input
                            className="modalCategory-input_email"
                            type="text"
                            id="email"
                            value={email}
                        ...
                        <label className="modalCategory-label">Phone</label>
                        <input
                            className="modalCategory-input"
                            type="text"
                            id="phone"
                        ...
                        <label className="modalCategory-label">Address</label>
                        <input
                            className="modalCategory-input"
                            type="text"
                            id="address"
                        ...
                        <div className='role__choose'>
                            <label className="modalCategory-label">Role: </label>
                ...
                <div className="modalCategory-footer">
